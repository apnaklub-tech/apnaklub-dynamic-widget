...
class PlaceholderWidgetParser extends WidgetParser {
  ...
  void assertionChecks(Map<String, dynamic> map) {
    ...
    typeAssertionDriver(
        map: map, attribute: 'strokeWidth', expectedType: TYPE_DOUBLE);
    typeAssertionDriver(
        map: map, attribute: 'fallbackWidth', expectedType: TYPE_DOUBLE);
    typeAssertionDriver(
        map: map, attribute: 'fallbackHeight', expectedType: TYPE_DOUBLE);
  }
