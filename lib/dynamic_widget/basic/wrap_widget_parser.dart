...
class WrapWidgetParser extends WidgetParser {
  ...
  void assertionChecks(Map<String, dynamic> map) {
    ...
    typeAssertionDriver(
        map: map, attribute: 'spacing', expectedType: TYPE_DOUBLE);
    typeAssertionDriver(
        map: map, attribute: 'runAlignment', expectedType: TYPE_STRING);
    typeAssertionDriver(
        map: map, attribute: 'runSpacing', expectedType: TYPE_DOUBLE);
    typeAssertionDriver(
