...
class TextFieldWidgetParser extends WidgetParser {
  ...
  void assertionChecks(Map<String, dynamic> map) {
    ...
    typeAssertionDriver(
        map: map, attribute: 'cursorColor', expectedType: TYPE_STRING);
    typeAssertionDriver(
    ...
    if (map.containsKey(inputDe) && map[inputDe] != null) {
      ...
      typeAssertionDriver(
          map: inputDeMap, attribute: 'iconColor', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'labelText', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'helperText', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'helperMaxLines', expectedType: TYPE_INT);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'hintText', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'hintMaxLines', expectedType: TYPE_INT);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'errorText', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'errorMaxLines', expectedType: TYPE_INT);
      typeAssertionDriver(
          map: inputDeMap,
      ...
      typeAssertionDriver(
          map: inputDeMap, attribute: 'prefixText', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap,
          attribute: 'prefixIconColor',
          expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'suffixText', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap,
          attribute: 'suffixIconColor',
          expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'counterText', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'fillColor', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'focusColor', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'hoverColor', expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'focusedBorder', expectedType: TYPE_MAP);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'enabledBorder', expectedType: TYPE_MAP);
      typeAssertionDriver(
          map: inputDeMap,
          attribute: 'semanticCounterText',
          expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap,
          attribute: 'alignLabelWithHint',
          expectedType: TYPE_STRING);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'constraints', expectedType: TYPE_MAP);
      typeAssertionDriver(
          map: inputDeMap, attribute: 'enabled', expectedType: TYPE_BOOL);
    }
  }
  ...
  Widget build(Map<String, dynamic> map, BuildContext buildContext,
    ...
    return TextField(
      ...
      onChanged: (text) => listener.onTextChange != null
          ? listener.onTextChange!(id, text)
          : null,
